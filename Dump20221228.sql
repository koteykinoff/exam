...
CREATE TABLE `role` (
  ...
  PRIMARY KEY (`role_id`),
  CONSTRAINT `role` FOREIGN KEY (`role_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `role` VALUES (1,'Админ'),(2,'Юзер');
...
INSERT INTO `users` VALUES (1,'111','111','1'),(2,'222','222','2');
...
-- Dump completed on 2022-12-28 11:58:56
